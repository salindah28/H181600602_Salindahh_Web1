                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   ...
                   <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                             ...
                             <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('artikel.index') }}">{{ __('Kategori Artikel') }}</a>
                                <a class="dropdown-item" href="{{ route('berita.index') }}">{{ __('Kategori Berita') }}</a>
                                <a class="dropdown-item" href="{{ route('galeri.index') }}">{{ __('Kategori galeri') }}</a>
                                <a class="dropdown-item" href="{{ route('pengumuman.index') }}">{{ __('Kategori Pengumuman') }}</a>
                           </div>
                            </li>
                            @endauth
                    </ul>
